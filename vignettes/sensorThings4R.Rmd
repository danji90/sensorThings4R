...
- Functions that store the SensorThings API Locations and FeaturesOfInterest in a data frame.
...
- A [Shiny Application](https://shiny.rstudio.com) to display the locations in a sensor network and the statin details 
